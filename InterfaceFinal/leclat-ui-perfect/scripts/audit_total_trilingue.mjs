...
const inviolables = [
  ...
  [
    "A3 col ne protégeait plus",
    1,
    "col ne le protégeait plus de rien",
    "collar no longer protected him",
    "الياقة لم تعد تحميه",
  ],
  [
  ...
  ["A6 Il refusa (×2)", 2, "Il refusa.", "He refused.", "رفض"],
  [
    "A7 sert à autre chose",
    1,
    "Ça ne se referme pas. Ça sert à autre chose.",
    "It doesn't close. It serves something else",
    "لا يُغلق",
  ],
  ["A8 pris du pain", 1, "pris du pain, je reviens avant la pluie", "taken bread", "أخذتُ خبزًا"],
  ["A10 Va dormir", 1, "— Va dormir.", "Go sleep", "اذهب لتنام"],
  ["B2 émail tient la fêlure", 1, "L'émail tient la fêlure.", "enamel holds the crack", "المينا"],
  ["B3 Nous avons le temps", 1, "Nous avons le temps.", "We have time", "لدينا الوقت"],
  ["B7 habituée", 1, "Je suis habituée.", "I'm used to it", "معتادة"],
